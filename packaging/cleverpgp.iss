...
begin
  ...
  Choice := MsgBox(
    'Удалить локальные данные Clever PGP?' + #13#10 + #13#10 +
    'Да — удалить настройки и локальные биометрические данные.' + #13#10 +
    'Нет — сохранить настройки для последующей переустановки.' + #13#10 +
  ...
  begin
    ...
    begin
      MsgBox(
        'Локальные данные не удалось удалить. ' +
